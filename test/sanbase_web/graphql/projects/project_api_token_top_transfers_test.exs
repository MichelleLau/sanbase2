defmodule Sanbase.Graphql.ProjectApiTokenTopTransfersTest do
  ...
  test "top token transactons for a project", %{conn: conn, project: project} do
    with_mock Sanbase.Clickhouse.Erc20Transfers,
      token_top_transfers: fn _, _, _, _ ->
        transactions()
      end do
      query = """
      {
  ...
  test "project with no contract address returns empty string", %{
    ...
    assert json_response(result, 200)["data"]["projectBySlug"] == %{"tokenTopTransfers" => []}
  end
  ...
  defp transactions() do
    [
      %Sanbase.Clickhouse.Erc20Transfers{
        ...
        dt: DateTime.from_naive!(~N[2018-06-10 10:33:47], "Etc/UTC"),
        from: "0xf4b51b14b9ee30dc37ec970b50a486f37686e2a8",
        logIndex: 0,
        to: "0x742d35cc6634c0532925a3b844bc454e4438f44e",
        transactionHash: "0x9a561c88bb59a1f6dfe63ed4fe036466b3a328d1d86d039377481ab7c4defe4e",
        value: 4.5488374321456405e25
      },
      %Sanbase.Clickhouse.Erc20Transfers{
        blockNumber: 5_769_021,
        contract: "0x7c5a0ce9267ed19b22f8cae653f198e3e8daf098",
        dt: DateTime.from_naive!(~N[2018-06-10 12:33:47], "Etc/UTC"),
        from: "0x416eda5d6ed29cac3e6d97c102d61bc578c5db87",
        logIndex: 2,
        to: "0xf9428b0e4959cb8d0e68d056a12dcd64ddef066e",
        transactionHash: "0xccbb803caabebd3665eec49673e23ef5cd08bd0be50a2b1f1506d77a523827ce",
        value: 8.990420000000001e23
      },
      %Sanbase.Clickhouse.Erc20Transfers{
        blockNumber: 5_770_231,
        contract: "0x7c5a0ce9267ed19b22f8cae653f198e3e8daf098",
        dt: DateTime.from_naive!(~N[2018-06-11 12:33:47], "Etc/UTC"),
        from: "0xf9428b0e4959cb8d0e68d056a12dcd64ddef066e",
        logIndex: 7,
      ...
      %Sanbase.Clickhouse.Erc20Transfers{
        ...
        contract: "0x7c5a0ce9267ed19b22f8cae653f198e3e8daf098",
        dt: DateTime.from_naive!(~N[2018-06-12 12:33:47], "Etc/UTC"),
        from: "0x17125b59ac51cee029e4bd78d7f5947d1ea49bb2",
        logIndex: 56,
        to: "0x8f47cc86055f35ba939ff48e569105183fea64e8",
      ...
      %Sanbase.Clickhouse.Erc20Transfers{
        ...
        contract: "0x7c5a0ce9267ed19b22f8cae653f198e3e8daf098",
        dt: DateTime.from_naive!(~N[2018-06-13 12:33:47], "Etc/UTC"),
        from: "0x8f47cc86055f35ba939ff48e569105183fea64e8",
        logIndex: 62,
        to: "0x876eabf441b2ee5b5b0554fd502a8e0600950cfa",
      ...
      %Sanbase.Clickhouse.Erc20Transfers{
        ...
        contract: "0x7c5a0ce9267ed19b22f8cae653f198e3e8daf098",
        dt: DateTime.from_naive!(~N[2018-06-14 12:33:47], "Etc/UTC"),
        from: "0x826d1ba25d5bf1485c755c8efecff3744f90d137",
        logIndex: 4,
        to: "0x4976b5204c10a8de91cbc9224fb6d314454cf7d8",
        transactionHash: "0x398772430a2e39f5f1addfbba56b7db1e30e5417de52c15001e157e350c18e52",
        value: 1.6667399999999998e23
      },
      %Sanbase.Clickhouse.Erc20Transfers{
        blockNumber: 5_569_715,
        contract: "0x7c5a0ce9267ed19b22f8cae653f198e3e8daf098",
        dt: DateTime.from_naive!(~N[2018-06-15 12:33:47], "Etc/UTC"),
        from: "0x4976b5204c10a8de91cbc9224fb6d314454cf7d8",
        logIndex: 7,
        to: "0x876eabf441b2ee5b5b0554fd502a8e0600950cfa",
      ...
      %Sanbase.Clickhouse.Erc20Transfers{
        ...
        contract: "0x7c5a0ce9267ed19b22f8cae653f198e3e8daf098",
        dt: DateTime.from_naive!(~N[2018-06-16 12:33:47], "Etc/UTC"),
        from: "0x17125b59ac51cee029e4bd78d7f5947d1ea49bb2",
        logIndex: 58,
        to: "0x0bd1b5cc4c63f99d00f4a3c5cad3619070c5c1c3",
        transactionHash: "0xa99da23a274c33d40d950fbc03bee7330e518ef6a9622ddd818cb9b967f9f520",
        value: 1.0e25
      },
      %Sanbase.Clickhouse.Erc20Transfers{
        blockNumber: 5_528_483,
        contract: "0x7c5a0ce9267ed19b22f8cae653f198e3e8daf098",
        dt: DateTime.from_naive!(~N[2018-06-17 12:33:47], "Etc/UTC"),
        from: "0x0bd1b5cc4c63f99d00f4a3c5cad3619070c5c1c3",
        logIndex: 53,
        to: "0x5e575279bf9f4acf0a130c186861454247394c06",
        transactionHash: "0x2110456180d0990d1f58c375faab828bb85abc16fe5e56264e84f32864708f3b",
        value: 1.0e25
      },
      %Sanbase.Clickhouse.Erc20Transfers{
        blockNumber: 5_812_594,
        contract: "0x7c5a0ce9267ed19b22f8cae653f198e3e8daf098",
        dt: DateTime.from_naive!(~N[2018-06-18 12:33:47], "Etc/UTC"),
        from: "0x1f3df0b8390bb8e9e322972c5e75583e87608ec2",
        logIndex: 14,
        to: "0x157dd308abb91ed2cd5a770bc1cf0fd458c7498c",
        transactionHash: "0x77ffc9c2ff1678d3f536357eb6e2a032981c98c46e541266ef152752f159187d",
        value: 8.3336e25
      }
    ]
  end
